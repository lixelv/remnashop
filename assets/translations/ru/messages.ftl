...
msg-menu-privacy-policy =
    <b>🔒 Политика конфиденциальности</b>

    <blockquote>
    Мы обрабатываем только те данные, которые нужны для работы бота и предоставления доступа к сервису:
    • Telegram ID, username и имя профиля
    • данные о подписке (срок, лимиты, статус)
    • технические данные, необходимые для подключения (например, список устройств, если включен лимит)
    </blockquote>

    <blockquote>
    Мы не запрашиваем и не храним:
    • пароли от Telegram
    • переписки и содержимое личных сообщений
    • данные банковских карт
    </blockquote>

    По вопросам обработки данных обратитесь в поддержку.

msg-menu-user-agreement =
    <b>📄 Пользовательское соглашение</b>

    <b>1) Общие положения</b>
    <blockquote>
    1.1. Настоящее пользовательское соглашение (далее — «Соглашение») регулирует отношения, возникающие при использовании сервиса и чат-бота (далее — «Сервис»).
    1.2. Лицо, использующее Сервис (далее — «Пользователь»), подтверждает, что ознакомилось с условиями Соглашения и принимает их в полном объеме.
    1.3. Начало использования Сервиса, в том числе любое взаимодействие с чат-ботом, считается акцептом Соглашения.
    1.4. В случае несогласия с условиями Соглашения Пользователь обязан прекратить использование Сервиса.
    </blockquote>

    <b>2) Сведения об исполнителе</b>
    <blockquote>
    2.1. Исполнитель: самозанятый Ефременко Симеон.
    2.2. ИНН: 781047814536.
    </blockquote>

    <b>3) Описание Сервиса</b>
    <blockquote>
    3.1. Сервис предоставляет Пользователю доступ к функционалу (включая оформление подписки и получение данных для подключения) на условиях выбранного тарифа/периода.
    3.2. Отдельные функции Сервиса могут быть доступны только при наличии активной подписки либо при соблюдении условий доступа, установленных Исполнителем.
    </blockquote>

    <b>4) Регистрация и идентификация</b>
    <blockquote>
    4.1. Идентификация Пользователя в рамках Сервиса осуществляется по Telegram ID.
    4.2. Пользователь несет ответственность за сохранность доступа к своему аккаунту Telegram, устройствам и программному обеспечению, используемым для доступа к Сервису.
    </blockquote>

    <b>5) Оплата и подписка</b>
    <blockquote>
    5.1. Стоимость, состав и условия подписки доводятся до сведения Пользователя в интерфейсе чат-бота до момента оплаты.
    5.2. Доступ к функционалу Сервиса предоставляется после подтверждения оплаты соответствующей платежной системой (либо после иного подтверждения, предусмотренного функционалом Сервиса).
    5.3. В случае технических сбоев Исполнитель вправе запросить у Пользователя сведения, необходимые для идентификации платежа (например, ID транзакции), исключительно в объеме, необходимом для проверки.
    </blockquote>

    <b>6) Возвраты и отмена</b>
    <blockquote>
    6.1. Возврат оплаты возможен при обращении Пользователя в поддержку при условии, что фактическое пользование Сервисом составило не более 1 (одного) дня с момента предоставления доступа/активации.
    6.2. Решение о возврате принимается Исполнителем по результатам проверки обращения и данных платежа.
    </blockquote>

    <b>7) Правила использования и ограничения</b>
    <blockquote>
    7.1. Пользователю запрещается использовать Сервис для целей и действий, нарушающих применимое законодательство.
    7.2. Запрещаются попытки несанкционированного доступа, взлома, обхода ограничений, вмешательства в работу Сервиса, а также распространение вредоносного программного обеспечения.
    7.3. Исполнитель строго заявляет: Сервис не предоставляет и не будет предоставлять доступ к платформам, ресурсам и сервисам, заблокированным на территории Российской Федерации.
    7.4. При нарушении условий Соглашения Исполнитель вправе ограничить или прекратить доступ Пользователя к Сервису без предварительного уведомления.
    </blockquote>

    <b>8) Ограничение ответственности</b>
    <blockquote>
    8.1. Сервис предоставляется на условиях «как есть». Исполнитель принимает разумные меры для поддержания работоспособности Сервиса, однако не гарантирует отсутствие ошибок и/или перерывов в работе.
    8.2. Исполнитель не несет ответственности за косвенные убытки, упущенную выгоду, а также за последствия действий третьих лиц и/или ограничений со стороны операторов связи, платформ, платежных систем либо государственных органов.
    </blockquote>

    <b>9) Персональные данные</b>
    <blockquote>
    9.1. Обработка информации о Пользователе осуществляется в соответствии с «Политикой конфиденциальности», размещенной в разделе «О сервисе».
    </blockquote>

    <b>10) Изменение условий</b>
    <blockquote>
    10.1. Исполнитель вправе в любое время изменять условия Соглашения. Актуальная версия Соглашения доступна в разделе «О сервисе».
    10.2. Продолжение использования Сервиса после изменения условий означает согласие Пользователя с обновленной редакцией.
    </blockquote>

    <b>11) Обратная связь</b>
    <blockquote>
    11.1. По вопросам работы Сервиса Пользователь обращается в поддержку через соответствующую кнопку меню.
    </blockquote>